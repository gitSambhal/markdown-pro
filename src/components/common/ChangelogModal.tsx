...
export const ChangelogModal: React.FC<ChangelogModalProps> = ({ isOpen, onClose }) => {
  return (
    <Modal isOpen={isOpen} onClose={onClose} onConfirm={onClose} title="What's New in v1.3.0" maxWidth="2xl">
      <div className="space-y-6 text-slate-300 text-sm leading-relaxed">
        ...
        <div className="flex items-center justify-between p-4 bg-indigo-950/40 border border-indigo-500/30 rounded-xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-semibold text-white">Markdown Viewer Pro v1.3.0</div>
              <div className="text-xs text-indigo-300">Interactive Landing Workspace & Refined Modals</div>
            </div>
          </div>
